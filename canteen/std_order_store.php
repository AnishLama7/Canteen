...
if (isset($data)>=1) {
        ...
        $result = db_query($con, $sql1);
         ...
         $sql2 = " INSERT INTO can_order SET order_name = '{$menu['name']}', order_price = '{$menu['price']}',  user_id = '{$user_id}', order_no = '{$menu['order_no']}', quantity = '{$menu['quantity']}', order_date = '{$now2}', order_time ='{$now1}',break_time = '{$break_time}', menu_id='{$menu['order_id']}'";
